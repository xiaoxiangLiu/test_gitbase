...
class LiancaiPlanOne(Page):
    ...
    def send_jiesuan_name(self):
        self.find_element(*self.input_jiesuan_name_loc).send_keys('联采-MH-2017年-9月水泥结算dan')
        return self
    ...
    def send_yufukuan(self):
        self.find_element(*self.input_yufukuan_loc).send_keys('12')
        return self

    # 填写备注
    def send_remark(self):
        self.find_element(*self.texterea_remark_loc).send_keys('联采-结算单基本信息页-备注')
        return self
